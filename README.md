...
- Merge pull request from alan-roe to set maxage on session-cookie
- disable registration
- german translation (based on GPT) (only language file, not hardcoded lines)
- load all RecentChats
- added own docker-compose.yaml
